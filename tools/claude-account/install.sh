...
echo "  $TOOL_NAME use [name]       # Switch accounts (current session)"
echo "  $TOOL_NAME default <name>   # Set default for new shells"
echo "  $TOOL_NAME list             # List saved accounts"
echo ""
echo "Shell init (add to .bashrc or .zshrc to restore default on new shells):"
echo "  eval \"\$($TOOL_NAME init)\""
